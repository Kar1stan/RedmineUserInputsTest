...
export class RegisterPage{
    ...
    async registerLogin(login:string){
    ...
    async registerPasswordConfirmation(password:string){
    ...
    async registerSurname(surname:string){
    ...
    async registerIRCnick(IRC:string){
